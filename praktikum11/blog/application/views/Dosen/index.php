...
<div class="col-md-12">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    class="btn btn-danger btn-lh active" onclick="return hapusDosen
                    ('Apakah Anda yakin ingin menghapus dosen yang bernama <?php echo $dsn-> nama ?> ?')" >Hapus</a>
                </td>
            </tr>
            <?php
            $nomor++;
    ...
    <a href= <?php echo base_url("index.php/dosen/form")?> class="btn btn-primary btn-lh active" >Tambah</a>
    </div>
</body>
</html>