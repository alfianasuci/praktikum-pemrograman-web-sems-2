        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-column align-items-center text-center">
                    <img src="<?= base_url()?>uploads/photos/<?=$guru->id?>.jpg" width="300">
                    <div class="mt-4">
                        <h4><?=$guru->nama?></h4>
                        <p>Foto Dosen</p>
                        <br/>
                        <a href="https://www.instagram.com/alfianasuci/"><button class="btn btn-outline-primary">Instagram</button></a>
